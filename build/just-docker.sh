...
docker run ${BUILD_ARGS_TERM} \
    ...
    victor-oe-builder bash -c "exec bash --rcfile <(echo \"cd ~/vicos-oelinux/poky && rm -rf build/tmp-glibc/deploy/images/apq8009-robot-robot-perf/* && source build/conf/set_bb_env.sh\")"
